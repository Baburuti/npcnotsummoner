module.exports = function npcsummoner(script) {	
    ...
    function sumMenu() {
        if (Object.keys(summons).length > 0) {
            ...
            gui.parse(list, `<font color="#E0B0FF">NPC Summon Menu</font>`);
            list = [];
        }
    }
	...
	script.hook('S_SPAWN_NPC', 11, (packet) => {	
		if (zoned == true) {
			...
			case merchant_template:
				...
				settingUpdate();				
				console.log("NPC Merchant identified, settings updated ", merchant_id);
				break;
			case vg_template:
				vg_id = packet.gameId;
				...
				settingUpdate();				
				console.log("NPC Merchant identified, settings updated: ", merchant_id);				
				console.log("NPC Vanguard Initiative, identified: ", vg_id);
				break;	
			case sp_template:
				sp_id = packet.gameId;
				...
				settingUpdate();				
				console.log("NPC Specialty Store identified, settings updated: ", sp_id);
				break;
			case fishmonger_template:
				...
				settingUpdate();				
				console.log("NPC Fish Monger identifed, settings updated: ", fishmonger_id);
				break;
			case fishcratevendor_template:
				...
				settingUpdate();				
				console.log("NPC Fish Crate Vendor identifed, settings updated: ", fishcratevendor_id);
				break;
			case fishmerch_template:
				...
				settingUpdate();				
				console.log("NPC Fish Merchant identifed, settings updated: ", fishmerch_id);
				break;			
			default:
				break;
			}
